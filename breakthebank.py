...
deathMenu = Scene(overallScreen.curr_screen, "imgs/pause_bg.png", [restart_button, tutorial_button, pause_title, quit_button, audio_button, accessibility_button], True)
